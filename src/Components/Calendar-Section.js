  ...
  return (
    <div className="appointment">
      ...
      <div className="schedule-info">
        ...
        <h1 className="perfect-for"><b>THIS AUDIT CALL IS PERFECT FOR:</b></h1>
        <ul>
          <li>
          ...
          <li>
            ...
            <p>
              ...
              <b>increased revenue potential </b> with funnels & conversion rate
              optimization.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              <b>maximize their conversion rates & average order value.</b>
            </p>
          </li>
          <li>
            <img src={Check} alt="Check" />
